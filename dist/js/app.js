(() => {
    ...
    if (document.querySelector(".products-slides__body")) new Swiper(".products-slides__body", {
        slidesPerView: 2,
        observer: true,
        observeParents: true,
        spaceBetween: 34,
    ...
    if (document.querySelector(".slider-recipes__body")) new Swiper(".slider-recipes__body", {
        slidesPerView: 1,
        observer: true,
        observeParents: true,
        spaceBetween: 0,
